 ...
 *
 * Usage:
 *   bun run scripts/generate-api-client.ts [--output ./src/common/resubaka-client.ts] [--branch main]
 */
...
`;
  ...
  return `/**
 * ═══════════════════════════════════════════════════════════════════════════════
 * Resubaka API Client — Auto-generated
 * ═══════════════════════════════════════════════════════════════════════════════
 *
 ...
 *   const client = new ResubakaClient("https://bitcraft-hub.example.com");
...
export class ResubakaApiError extends Error {
  constructor(
...
export interface ResubakaClientOptions {
...
export class ResubakaClient {
  private readonly baseUrl: string;
  private readonly fetchFn: typeof globalThis.fetch;
  private readonly defaultHeaders: Record<string, string>;
  private readonly timeout: number;

  constructor(baseUrlOrOptions: string | ResubakaClientOptions) {
  ...
  protected async request<T>(path: string): Promise<T> {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new ResubakaApiError(response.status, response.statusText, body, url);
      }
